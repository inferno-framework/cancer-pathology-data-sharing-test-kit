  ...
  class EncounterValidationTest < Inferno::Test
    ...
    run do
      ...
      scratch[:cpds_resources].each do |bundle_id, bundle_resources|
        ...
        invalid_bundles << bundle_id if perform_strict_validation_test('Encounter', bundle_id, resources, profile_url, '5.0.1', skip_if_empty: false, restriction: "no_more_than_one")
      end
